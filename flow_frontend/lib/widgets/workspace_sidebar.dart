...
class _WorkspaceSidebarState extends State<WorkspaceSidebar> {
  ...
  void initState() {
    ...
    PageManager.instance.addListener(_onPageManagerChanged);
  ...
  @override
  void dispose() {
    PageManager.instance.removeListener(_onPageManagerChanged);
    super.dispose();
  }

  void _onPageManagerChanged() {
          ...
          _pages = pagesData
              .map(
                (pageData) => WorkspacePage(
                  ...
                  isActive: pageData['id'] == pageManager.activePageId,
                ),
              )
              .toList();
        });
