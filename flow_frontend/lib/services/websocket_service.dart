...
class WebSocketService with ChangeNotifier {
  ...
  static WebSocketService get instance {
    // If the instance exists but is disposed, create a new one
  ...
  void _addLog(
    ...
    // Don't add logs if service is disposed
    ...
    // Only call notifyListeners if not disposed
    if (!_isDisposing) {
      notifyListeners();
    }
  }
  ...
  Future<void> connect(String? token) async {
    ...
    // If we're already connected, don't reconnect unless token changed
