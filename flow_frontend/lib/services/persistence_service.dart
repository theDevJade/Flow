...
class PersistenceService {
  ...
  // Terminal Page States (for complex terminal state including current directory, etc.)
  ...
  // WebSocket Configuration Persistence
  ...
  // Getter methods for WebSocket configuration
