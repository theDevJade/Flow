...
class FlowLangParameter(
    ...
    companion object {
        fun create(name: String, typeName: String, isOptional: Boolean, defaultValue: Any?): FlowLangParameter {
            return FlowLangParameter(name, typeName, isOptional, defaultValue)
        }
    }
}
