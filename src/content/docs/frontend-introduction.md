---
title: Introduction
description: Welcome to Flow Frontend - A modern Flutter application
---

# Flow Frontend Introduction

Flow Frontend is a modern Flutter application that combines visual graph editing with a full-featured code editor, designed with an Atom-style interface and dark theme.

## What is Flow Frontend?

Flow Frontend is a powerful development environment that provides:

- **Dual Workspace Architecture**: Visual graph editing and code editing in one application
- **Modern UI/UX**: Dark theme with professional color scheme and smooth animations
- **Real-time Communication**: WebSocket-based real-time features
- **File System Integration**: Tree-based file explorer with multi-tab editing
...
- [Architecture](/frontend-architecture) - Technical architecture details
