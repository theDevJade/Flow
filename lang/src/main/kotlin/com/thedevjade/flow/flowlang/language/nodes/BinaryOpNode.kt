...
class BinaryOpNode(
    ...
    class FunctionDefNode(
        ...
        override fun execute(context: FlowLangContext): Any? {
            ...
            FlowLangEngine.Companion.getInstance().registerFunction(FlowLangFunction(name, impl, sparams))
            return null
        }
    }
    ...
    class EventHandlerNode(
        ...
        override fun execute(context: FlowLangContext): Any? {
            val event = FlowLangEngine.Companion.getInstance().getEvent(eventName)
