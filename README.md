...
> **Flow** is a Kotlin-infused playspace combining **FlowLang**, a custom scripting language, with a **graph editor** and **terminal**—all optimized for performance and extensibility.
