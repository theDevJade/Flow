...
import com.thedevjade.flow.extension.executor.GraphExecutor
...
class ExtensionManager(
    ...
    suspend fun executeGraph(
        graph: com.thedevjade.flow.api.graph.FlowGraph,
        inputs: Map<String, Any?> = emptyMap(),
        context: com.thedevjade.flow.extension.executor.GraphExecutionContext? = null
    ): com.thedevjade.flow.extension.executor.GraphExecutionResult {
    ...
    suspend fun executeNode(
        ...
        inputs: Map<String, Any?> = emptyMap(),
        context: com.thedevjade.flow.extension.executor.GraphExecutionContext? = null
    ): com.thedevjade.flow.extension.executor.NodeExecutionResult {
    ...
    fun getActiveExecutions(): Map<String, com.thedevjade.flow.extension.executor.GraphExecution> =
    ...
    fun unregisterExtensionFromRegistry(extensionName: String) {
        ...
        val extensionClass = extensionInfo.extension::class
        // Note: SimpleExtensionRegistry doesn't have unregisterExtension method
        // @TODO ADD
    }
