...
/**
 * Comprehensive graph management system for Flow.
 * Handles graph creation, persistence, collaboration, and versioning.
 */
class GraphManager(
    ...
    private val userGraphs = ConcurrentHashMap<String, MutableSet<String>>() // userId -> graphIds
    private val graphCollaborators = ConcurrentHashMap<String, MutableSet<String>>() // graphId -> userIds
    ...
    /**
     * Get graphs a user can access (owned + shared)
     */
