...
class HotReloadExtensionLoader(
    ...
    suspend fun reloadExtension(extensionName: String): ExtensionReloadResult {
        val loadedExtension = loadedExtensions[extensionName]
            ?: return ExtensionReloadResult.Failure("Extension not found: $extensionName")
        ...
        return try {
            ...
            when (val result = loadExtension(jarFile)) {
