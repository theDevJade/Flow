...
object FlowLogger {
    ...
    object Database {
        ...
        fun debug(message: String, throwable: Throwable? = null) = debug(COMPONENT, message, throwable)
        fun info(message: String, throwable: Throwable? = null) = info(COMPONENT, message, throwable)
        fun warn(message: String, throwable: Throwable? = null) = warn(COMPONENT, message, throwable)
        fun error(message: String, throwable: Throwable? = null) = error(COMPONENT, message, throwable)
    }
