...
IPCValue JVMAdapter::callStatic(const std::string& className, const std::string& methodName,
    ...
    for (const auto& arg : args) {
        switch (arg.type) {
            case IPCValue::Type::INT: signature += "I"; break;
            case IPCValue::Type::FLOAT: signature += "D"; break;
            case IPCValue::Type::STRING: signature += "Ljava/lang/String;"; break;
            case IPCValue::Type::BOOL: signature += "Z"; break;
            default: break;
        }
    }
